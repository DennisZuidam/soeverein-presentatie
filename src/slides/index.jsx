...
//
// Elk item heeft `notes` (de volledige spreeknotitie, bron van waarheid, ook
// voor de sprekerskaartjes) en `cues`: korte steekwoord-bullets die het
// spreker-venster standaard toont. De volledige notitie zit er in dat venster
// één toets (N) achter.
export const slides = [
  {
    Component: Slide01,
    cues: [
      "Titel = de stelling: \"eu\" maakt je cloud niet Europees",
      "Drie delen: waarom vastzit · wie bevrijdde · hoe zelf bouwt",
      "Demo als climax, korte epiloog",
      "Sprekers na mij gaan de AI-diepte in",
      "Ik geef de meetlat om hun verhalen te plaatsen",
    ],
    notes:
  ...
  },
  {
    ...
    cues: [
      "Koud openen: geen naam, geen agenda, meteen het scenario",
      "Na \"plan B?\" tien seconden stilte, niet invullen",
      "Doel: besef, geen doembeeld",
      "Ook een meetvraag: straks een getal (time-to-exit)",
      "Nog niet verklappen, door naar wie ik ben",
    ],
    notes:
  ...
  },
  {
    ...
    steps: 3,
    cues: [
      "Warme kennismaking na de schrik-opener, houd het licht",
      "Elke stap onthult een categorie: werk, gezin, hobby",
      "Kort persoonlijk: XPRTZ en podcasts, gezin, koken/bakken/sporten",
      "Geen cv, even mens zijn voor de zaal",
      "Geloofwaardig als volger en duider, niet als expert",
      "Brug: wanneer koos jij bewust je cloudprovider?",
    ],
    notes:
  ...
  // ---- Deel 1 · Waarom je vastzit ----
  {
    ...
    cues: [
      "Opent Deel 1, wijs op de deel-rail onderin",
      "Lock-in zit in state, identiteit, coercion points",
      "Bijna niemand koos die binding bewust",
      "Toon: geen verwijt",
    ],
    notes:
  ...
  },
  {
    Component: Slide04,
    cues: [
      "Lock-in begint niet bij het contract",
      "Maar bij 'aws configure' in een README, een tutorial",
      "Niemand zei nee, niemand zei ja",
      "De keuze is nooit echt gemaakt",
    ],
    notes:
  ...
  },
  {
    Component: Slide05,
    cues: [
      "Lock-in is concreet, herkenbaar in je eigen stack",
      "DynamoDB: single-table rond query-patronen, migratie kost maanden",
      "IAM: rollen diep verweven",
      "Egress: exit-egress gratis sinds 2024, rente zit in doorlopend verkeer",
      "$0,09/GB na 100GB · 300TB ≈ 20k · Hetzner 20TB inbegrepen",
      "Geen AWS-bashing: Azure en Google net zo",
      "Bron: wz-it.com · dev.to/gpuperhour",
    ],
    notes:
  ...
  },
  {
    ...
    cues: [
      "Lock-in is geen zonde maar een lening",
      "Soms precies goed: startup, snelheid, weinig state",
      "Niet 'vermijd lock-in' maar 'ken je de rente'",
      "Links slim lenen, rechts wanneer de rekening komt",
      "Rente betaal je in state, identiteit, coercion points",
    ],
    notes:
  ...
  },
  {
    Component: Slide06,
    cues: [
      "Vier gevallen over vijftien jaar, één mechanisme",
      "De buitenwereld reikt tot in je cloud, geen losse incidenten",
      "ICC-aanklager Khan: account dicht na VS-sanctie (Microsoft betwist bredere lezing)",
      "AWS haalt Parler offline in 24u (jan 2021)",
      "Amazon zet WikiLeaks eraf (2010)",
      "AWS/Azure/Google schorten diensten in Rusland (maart 2022)",
      "Telkens buiten de macht van de klant",
      "Brug: Microsoft zei dit zelf, onder ede",
    ],
    notes:
  ...
  },
  {
    ...
    cues: [
      "Sterkste moment van Deel 1, neem rust",
      "Geen speculatie: uitspraak onder ede",
      "Franse Senaat, 10 juni 2025",
      "Carniaux (Microsoft France): \"Non, je ne peux pas le garantir\"",
      "Bij een VS-bevel moeten we de data overdragen",
      "Laat de quote even staan",
      "Brug: en Europees kiezen dan? Kijk naar Solvinity",
    ],
    notes:
  ...
  },
  {
    ...
    steps: 5,
    cues: [
      "Solvinity zit achter DigiD, komt dichtbij",
      "Zelfs Europees kiezen geeft geen zekerheid",
      "Nederlands van oorsprong, al jaren Brits (VK is geen EU)",
      "Nov 2025: Kyndryl wil overnemen",
      "Mei 2026: staatssecretaris Aerdts verbiedt overname",
      "Beroep loopt, rond 6 juli rechtbank Rotterdam",
      "CHECK DE ACTUELE STAND vlak voor de avond",
      "Les: zelfs een verbod is geen zekerheid, alleen exitvermogen",
      "Bron: nos.nl 2615885 · 2618922 · ictrecht.nl",
    ],
    notes:
  ...
  },
  {
    Component: Slide07,
    cues: [
      "Naam zegt 'eu', alleen de servers staan hier",
      "Bedrijf in Seattle, wet in Washington (CLOUD Act, FISA 702)",
      "Juridisch telt maar één plek, niet Dublin",
      "Het mechanisme onder alle voorbeelden",
      "Brug: versleutelen of sovereign cloud dan?",
    ],
    notes:
  ...
  },
  {
    ...
    cues: [
      "Weinig tekst, jij brengt het verhaal",
      "Geen truc ontsnapt aan jurisdictie, de eigenaar valt eronder",
      "Encryptie: CLOUD Act pakt 'control', BYOK verschuift enkel, alleen HYOK erbuiten",
      "Air-gap: zelfde moederbedrijf = zelfde jurisdictie",
      "Enclaves: eigenaar te dwingen via patches, hypervisor",
      "Zero-knowledge: sealed order kan gericht lek afdwingen, mag niet verteld",
      "Sovereign clouds: echte poging, maar Microsoft gaf onder ede toe: geen garantie",
      "Kill-quote: soevereiniteitsclaim van VS-provider = marketing, geen spec",
      "Eerlijk: verkleint risico, neemt coercion points niet weg",
      "Bron: eliatra.com · julsimon.medium.com · infoq.com",
    ],
    notes:
  ...
  },
  {
    ...
    cues: [
      "Nieuwste rung, meest actueel",
      "Bouw op: data onder CLOUD Act, account dicht (ICC), nu de AI-modellen zelf",
      "EO 14409, 2 juni 2026",
      "NSA-directeur bepaalt via geclassificeerde cyberbenchmark: 'covered frontier model'",
      "Tot 30 dagen vóór release toegang geven",
      "Eerlijk: vrijwillig, zeg 'een poort', niet 'blokkeert AI'",
      "Antwoord: open weights (Mistral) = open standaarden voor AI",
      "Haakje: EO 2 juni, EU-pakket 3 juni",
      "Bron: federalregister.gov 2026-11415 · techpolicy.press",
    ],
    notes:
  ...
  },
  {
    Component: Slide09,
    cues: [
      "De kernzin, afsluiting Deel 1",
      "Soevereiniteit als doel: vlaggetjes-denken",
      "Keuzevrijheid als doel: goede architectuur",
      "Soevereiniteit krijg je er gratis bij",
      "Laat het even hangen",
    ],
    notes:
  ...
  // ---- Deel 2 · Wie zich al bevrijdde ----
  {
    ...
    cues: [
      "Belangrijk onderscheid voor de voorbeelden",
      "Europees kiezen = bestemming, andere vlag, kan van eigenaar wisselen (Solvinity)",
      "Keuzevrijheid = architectuur: containers, open standaarden, porteerbare data",
      "Pas dat tweede maakt de Europese keuze veilig",
      "Laat de zaal zelf herkennen wat wat is",
    ],
    notes:
  ...
  },
  {
    ...
    cues: [
      "Overgang naar Deel 2",
      "Deel 1 was het waarom, nu: het gebeurt al",
      "Mensen en organisaties zijn er nu al mee bezig",
      "Eerlijk: DNB en Airbus zijn intenties, geen afgeronde migraties",
      "Tempo vasthouden",
    ],
    notes:
  ...
  },
  {
    ...
    cues: [
      "Groot en klein, telkens: compute verhuist makkelijk, state is het werk",
      "GEICO: multi-cloud (Azure grootste, NIET all-in AWS), rekening 2,5x, terug naar eigen, 50%+ goedkoper",
      "Dropbox: ~500PB grotendeels van S3 naar Magic Pocket, $74,6M bespaard (2016-2017)",
      "OneUptime: van $38k/mnd naar bare metal, run-rate naar >$1,2M/jr (geen cumulatief)",
      "Spotify: Europees, maar alleen via Apples App Store; EU-boete €1,84 mld (4 mrt 2024)",
      "Epic/Fortnite: eigen betaling, uit stores (aug 2020), terug via DMA",
      "Punt: distributie én advertenties zijn coercion points buiten je infra",
      "37signals bewaar ik voor zo",
      "Bron: thestack · geekwire · oneuptime.com · ec.europa.eu · engadget",
    ],
    notes:
  ...
  },
  {
    Component: Slide14,
    cues: [
      "Breed: van onderzoeksjournalistiek tot Airbus, DNB, Rijk",
      "Labels tonen het onderscheid: meesten Europese bestemming",
      "Rijk deed allebei: Europese bestemming + exitclausule (STACKIT, 23 april 2026)",
      "The Firewall: kort geding DigiD afgewezen",
      "Airbus: aanbesteding, intentie",
      "Venijnige vraag: waarom Duits STACKIT? De exitclausule telt, de vlag niet",
      "Bron: rijksoverheid.nl · techzine.eu · computable.nl",
    ],
    notes:
  ...
  },
  {
    Component: Slide10,
    cues: [
      "Verhaal dat blijft hangen: DHH, 10 jaar AWS, dan cloud-exit",
      "Quote uit \"Why we're leaving the cloud\" (okt 2022), laat landen",
      "Infra van $3,2M naar <$1M/jaar",
      "S3-exit: ~10PB / 5 mld objecten naar Pure Storage, $1,5M eenmalig, <$200k/jr",
      "De '$10M/5jr' is DHH zijn projectie, geen audit",
      "Zomer 2025: AWS-account dicht, naar eigen infra",
      "Hij bouwde Kamal (uit de demo)",
      "Component voor component, geen big bang",
      "Bron: world.hey.com/dhh · theregister.com",
    ],
    notes:
  ...
  },
  {
    Component: Slide11,
    cues: [
      "Kelsey Hightower vat het samen",
      "Bewegen zonder toestemming ís soevereiniteit",
      "Niet politiek, praktisch",
      "Check: letterlijk uit Civo Navigate London 2025? Zo niet, kondig aan als parafrase",
    ],
    notes:
  ...
  },
  {
    Component: Slide15,
    cues: [
      "Ook het beleid beweegt mee",
      "EU Tech Sovereignty Package (3 juni 2026)",
      "Open source in het hart van industriepolitiek (niet 'voor het eerst', strategie uit 2020)",
      "Cloud and AI Development Act: open-source-first voor inkoop, €2 mld / 7 jaar",
      "80% digitale tech geïmporteerd, 70% AI-modellen uit VS",
      "Callback: EO 2 juni, pakket 3 juni, veelzeggend toeval",
      "Porteerbaar deployen wordt aanbestedingscriterium",
      "Bron: commission.europa.eu · techpolicy.press",
    ],
    notes:
  ...
  },
  {
    ...
    cues: [
      "Afsluiter Deel 2, bewust datagedreven",
      "61% West-Europese CIO's zet meer in op lokale cloud door geopolitiek (Gartner, 241 CIO's)",
      "55% open source cruciaal · 53% beperkt globale providers",
      "2030: >75% bedrijven buiten VS met soevereiniteitsstrategie",
      "Punchline: geen repatriation maar 'geopatriation'",
      "Breng de cijfers, lees ze niet op",
      "Bron: gartner.com (12 nov 2025) · theregister · channelweb",
    ],
    notes:
  ...
  // ---- Deel 3 · Hoe je het zelf bouwt (incl. demo) ----
  {
    ...
    cues: [
      "Divider Deel 3, geen technisch college",
      "De techniek zit in de demo, niet in de slides",
      "Container is een avondje werk, echte lock-in in state, identiteit, coercion points",
      "KLOK-CHECKPOINT: niet op tweederde? Gebruik de noodsnit",
      "Verleiding: 'containeriseer alles en je bent vrij', juist dat misverstand",
    ],
    notes:
  ...
  },
  {
    ...
    cues: [
      "Slide leest als 'container is je exitstrategie', te makkelijk",
      "Container was altijd al porteerbaar (OCI), dat is het lokaas",
      "Echte binding: state (data verhuist niet), identiteit (IAM herschrijven), coercion points",
      "Kernthese: keuzevrijheid telt, niet het label",
      "Brug: waar zitten die lagen, hoe blijven ze porteerbaar",
    ],
    notes:
  ...
  },
  {
    ...
    cues: [
      "De meetlat van de avond, neem tijd",
      "'Cloud-agnostisch' is een sprookje, hoeft ook niet",
      "Bruikbaar: replaceability, hoe snel en hoe duur kom je los",
      "Twee getallen: time-to-exit en cost-to-exit, als SLA op papier",
      "Voorbeeld: binnen 6 weken weg, voor 40 mille, jaarlijks geoefend",
      "Getallen zijn voorbeeld, architect herijkt",
      "Coercion points: juridisch getal, overrulet je architectuur",
      "Omkering: soevereiniteit is bijproduct van lage exit-getallen",
    ],
    notes:
  ...
  },
  {
    ...
    steps: 5,
    cues: [
      "Vier blokjes op pijltje-rechts, punchline als vijfde",
      "SCHRAPKANDIDAAT bij tijdnood: kern als gesproken zin bij de scorecard",
      "Onderhandelingspositie: wie kan vertrekken hoeft niet te smeken",
      "Betere architectuur: porteerbaar = zelfde discipline als testbaar",
      "Reproduceerbaarheid: één artefact van laptop tot productie",
      "Soevereiniteit gratis erbij, als bijproduct",
    ],
    notes:
  ...
  },
  {
    Component: Slide19,
    cues: [
      "De demo: deze presentatie, live van Azure naar Scaleway nl-ams, met Kamal",
      "Bewust stateless: je ziet de makkelijke helft",
      "Url verspringt per cloud (sslip.io = het IP)",
      "Eerlijk: geen state = time-to-exit bijna nul, echte werk in data/identiteit/coercion",
      "Zelfde config wijst met één vlag naar Hetzner",
      "Bij 'jij werkt toch met Scaleway?': geldt óók tegen Scaleway, daarom -d hetzner",
      "Zie demo/record-demo.sh",
    ],
    notes:
  ...
  },
  {
    ...
    steps: 6,
    cues: [
      "De climax, volledig gescript, elk getal en host uit een echte run",
      "Stuur met pijltje-rechts, zes beats",
      "1 · terminal deployt naar Azure (~103s, stopwatch loopt mee)",
      "2 · linkerframe: slide 1 live op 51-124-164-67.sslip.io, wijs op de host",
      "3 · Scaleway, echte hapering: poort 22 dicht (ECONNREFUSED), retry 27,8s",
      "Zeg hardop: geen video, echte machine, sshd moet wakker worden",
      "4 · rechterframe: zelfde slide op 51-15-113-112.sslip.io, alleen het IP verschilt",
      "5 · terminal: az group delete op Azure",
      "6 · linkerframe 'not found', Amsterdam draait door",
    ],
    notes:
  ...
  },
  {
    ...
    cues: [
      "Lees van boven naar beneden, bewust oplopend",
      "Compute, registry, DNS: seconden tot minuten (open standaarden)",
      "Bovenste rij = wat iedereen 'de migratie' noemt, triviaal",
      "De twee onderste rijen doen pijn",
      "Schaalzin hardop: 14GB zonder downtime = minuten, terabytes = weken",
      "Identiteit: herbouwen, niet exporteren; bevel komt via je account",
      "Landing: soevereiniteit = de langste time-to-exit in je stack",
      "Staat dat getal bij je container? Dan niets gemeten",
    ],
    notes:
  ...
  // ---- Epiloog ----
  {
    ...
    steps: 1,
    cues: [
      "Vier stappen, één besef: je weet pas hoe vast je zit als je het probeert",
      "Waar zit je vast · wat draait al in een container · staat je infra in code",
      "Vierde maakt het meetbaar: backup terugzetten bij een tweede provider, klok de tijd",
      "Dat getal is je time-to-exit, de meesten kennen het niet",
      "Geen backup buiten je provider? Dat is de eerste realisatie",
      "Concreet: één dag, één service, tweede provider, om te wéten",
    ],
    notes:
  ...
  },
  {
    Component: Slide22,
    cues: [
      "Demo-code staat op GitHub, dat is Microsoft, ironisch, laat landen",
      "Punt: porteerbare code houdt de keuze open",
      "Beter alternatief? Kan mee, naar Forgejo of waar dan ook",
      "Het label doet er niet toe, de porteerbaarheid wel",
      "Dat is keuzevrijheid, de hele boodschap in drie woorden",
    ],
    notes:
  ...
  },
  {
    ...
    cues: [
      "Slotwoord, mic-drop, laat het hangen",
      "Niet 'Europees kiezen', niet soevereiniteit, maar keuzevrijheid",
      "Rustig, één woord, dan door naar de meetlat-vraag",
      "Keuzevrijheid is geen gevoel maar weken en euro",
    ],
    notes:
  ...
  },
  {
    Component: Slide23,
    cues: [
      "Blijft de hele Q&A staan, bedank kort, wijs op de links",
      "1 · 'AWS Sovereign Cloud?' Andere vlag, zelfde moederbedrijf, Carniaux ging hierover",
      "2 · 'Data Privacy Framework?' Schrems I en II: hangt aan één rechtszaak, check DPF-status",
      "3 · 'Jij werkt met Scaleway?' Geldt óók tegen Scaleway, daarom -d hetzner",
      "4 · 'pg_dump vereist een account?' Gedwongen exit begint bij backup buiten de provider",
      "5 · 'Egress bij exit gratis?' Klopt eenmalig, rente in doorlopend verkeer",
      "6 · 'Waarom Duits STACKIT?' De exitclausule telt, de vlag niet",
      "7 · 'Alle cases zijn successen?' Klopt, daarom is meten belangrijker dan verhuizen",
      "8 · 'Mistral heeft Microsoft-deal?' Open weights verhuizen in uren, fine-tune bij closed niet",
    ],
    notes:
  ...
  },
  {
    ...
    cues: [
      "Afsluiter, helemaal aan het eind",
      "Bedank de zaal, kernboodschap nog één keer",
  ...
  // ---- Bijlage · reserveslides voor de Q&A ----
  {
    Component: Slide16,
    cues: [
      "Loop de lagen langs, geen checklist",
      "Links waar je nu zit, rechts de open standaard; groen = bestaat al",
      "Observability: Coinbase betaalde Datadog naar verluidt $65M (2021, afgeleid)",
      "DNS4EU op Knot Resolver (CZ.NIC), 100% EU-gehost",
      "Bron: pragmaticengineer · whalebone.io/dns4eu",
    ],
    notes:
  ...
  },
  {
    Component: Slide18,
    cues: [
      "Eerlijk zijn, die eerlijkheid is zelf het punt",
      "Kleinere community, minder managed services",
      "Managed services = ops-team dat je huurt; zonder hen zelf doen of inhuren",
      "Echte bezwaar van elke IT-manager, maakt de cases juist geloofwaardig",
      "Voor cloud-native stack is het verschil klein en wordt kleiner",
    ],
    notes:
  ...
  },
  {
    ...
    steps: 1,
    cues: [
      "Vier plekken waar vast of vrij valt, breng als herkenning",
      "Open alternatief ligt klaar: S3 API, PostgreSQL, K8s",
      "Config via env vars (twelve-factor), IaC (Terraform/Pulumi), stateless apps",
      "Elke SDK-binding is een keuze, het open equivalent bestaat al",
      "Identiteit: OIDC/OAuth2 in plaats van Cognito/Entra (Keycloak, Zitadel)",
      "Wet beweegt mee: Data Act nu, switching fees verboden vanaf jan 2027",
      "Wie porteerbaar bouwt heeft de wet niet eens nodig",
      "Bron: aws.amazon.com/blogs · european-alternatives.eu",
    ],
    notes:
  ...
  },
  {
    ...
    cues: [
      "Bronvermelding, puur naslag",
      "Alleen tonen bij een Q&A-vraag om bronnen",
      "Drie kolommen: jurisdictie/wet, cases/cijfers, beleid/normen/onderzoek",
      "Volledige lijst met links in de spreektekst",
    ],
    notes:
