...
export const slides = [
  ...
  },
  {
    ...
    steps: 4,
    notes:
      'Dit is het antwoord op de vraag die na de schrik-opener in de zaal hangt: wie is deze man en waarom vertelt hij dit? Houd het licht, hier mag even lucht in na het slot-scenario.\n\nDe terminal onthult zich regel voor regel: je landt op "whoami" (naam en rol), en elke druk op pijltje-rechts toont het volgende blok. Loop ze hardop langs: waar draait onze software (Europese cloud), en waarom (niet omdat het moest, maar omdat het beter uitkwam, de belangrijkste regel). Dat is de geloofsbrief van vanavond: ik ga je straks niets vragen wat wij zelf niet allang doen.\n\n[VUL IN: bij het "waarom"-blok, één echt waargebeurd moment van 20 tot 30 seconden. Bijvoorbeeld: wat destijds de doorslag gaf om de eigen software op een Europese cloud te zetten, wat er meeviel of juist tegenviel, of het moment waarop die praktische keuze opeens een strategisch verhaal werd. Eén concreet beeld, geen cv. Verzin niets; heb je geen scherp moment, vertel dan eerlijk hoe die afweging ging.]\n\nHet voorlaatste blok ("en waarom sta je hier dan") blijft met een knipperende cursor open staan. De volgende pijl onthult de punchline, het antwoord: ik kom je niet bekeren, dit is een risicoverhaal, geen kruistocht. Daarna nog een pijl om door te gaan.\n\nBrug naar de volgende slide: wij maakten die keuze ooit bewust, en dat blijkt zeldzamer dan je denkt. Wanneer koos jij eigenlijk je cloudprovider?',
  },
  {
    Component: Slide03,
    notes:
